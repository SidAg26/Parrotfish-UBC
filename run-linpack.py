...
config_file_path = './config-linpack.json'
# Path to the results file
results_file_path = './results-workbench-linpack.json'
# Payload file path 
payload_file_path = '/home/ubuntu/memFigLessDIR/Mem-Fig-Less/estimation-algorithms/results-workbench-linpack.json'
...
mean_duration = int(5472 * 1.5) # 50% increase in the mean duration from metadata
