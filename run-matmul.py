...
config_file_path = './config-matmul.json'
# Path to the results file
results_file_path = './results-workbench-matmul.json'
# Payload file path 
payload_file_path = '/home/ubuntu/memFigLessDIR/Mem-Fig-Less/estimation-algorithms/results-workbench-matmul.json'
...
mean_duration = int(7722 * 1.5) # 50% increase in the mean duration from metadata
