...
config_file_path = './config-bfs.json'
# Path to the results file
results_file_path = './results-graph-bfs.json'
# Payload file path 
payload_file_path = '/home/ubuntu/memFigLessDIR/Mem-Fig-Less/estimation-algorithms/results-graph-bfs.json'
...
mean_duration = int(3407 * 1.5) # 50% increase in the mean duration from metadata
