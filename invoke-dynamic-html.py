...
function_name = 'sebs-dynamic-html'
json_file_path = '/home/ubuntu/memFigLessDIR/Parrotfish-UBC/results-dynamic-html.json'
...
for i in range(len(payload)):
    if memory[i] != 0:
        ...
        if _invoke_result:
            ...
            with open('dynamic-html_data.json', 'a') as file:
